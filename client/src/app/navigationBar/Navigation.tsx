            ...
            <div className={styles.wrapper}>
              ...
              <ul className={styles.ul}>
                ...
                <NavigationButton
                  setIsLoading={setIsLoading}
                  currentPage={page}
                  pageTitle="aboutOurClub"
                />
                <NavigationButton
                  setIsLoading={setIsLoading}
                  currentPage={page}
                  pageTitle="bulletinBoard"
                />
                <NavigationButton
                  setIsLoading={setIsLoading}
                  currentPage={page}
                  pageTitle="currentlyReading"
                />
                <NavigationButton
                  setIsLoading={setIsLoading}
                  currentPage={page}
                  pageTitle="discountDirectory"
                />
                <NavigationButton
                  setIsLoading={setIsLoading}
                  currentPage={page}
