...
export default async function clubStatistics() {
  ...
  const displayAverageRating =
    currentlyReadingBook?.book.averageRating === -1
      ? "No Readers"
      : currentlyReadingBook?.book.averageRating.toFixed(2) ?? "";
    ...
    <div className={styles.container}>
      ...
      <section>
        ...
        <AStatistic
          ...
          value={currentlyReadingBook?.book.title ?? ""}
        />
        ...
        <AStatistic
          title="Bulletin Engagement"
          value={`${(bulletinEngagement * 100).toFixed(1)}%`}
        />
      </section>
      <section>
