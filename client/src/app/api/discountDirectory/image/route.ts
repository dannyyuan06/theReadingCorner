...
const bucketName = 'discountdirectory'
...
export async function POST(req: NextRequest) {
    ...
    const gcsFileName = Math.random().toString(16).slice(2) + (new Date()).valueOf() + '.jpg'; // You can set any desired file extension here, depending on the image format
