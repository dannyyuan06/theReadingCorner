...
export function CurrentlyReadingBook({
  ...
  currentlyReading: getCurrentlyReadingBooksType;
}) {
  ...
  const displayAverageRating =
    book.averageRating === -1 ? "-" : book.averageRating.toFixed(2) ?? "";
  return (
      ...
      <div className={styles.textContainer}>
        <div className={styles.headerBodySeparator}>
          <div className={styles.titles}>
            ...
            <h3>
              AUTHOR{book.author.includes(",") && "S"}: {book.author}
            </h3>
            <h3>
              START DATE:{" "}
              <span>
                {new Date(current.dateStarted)
                  .toDateString()
                  .split(" ")
                  .slice(1)
                  .join(" ")}
            ...
            <h3>
              PAGE:{" "}
              <span>
                {current.pageNumber === -1 ? "" : current.pageNumber}/
                {book.pageCount}
              </span>
            </h3>
            <h3>
            ...
            <h3>
              AFFILIATE LINK:{" "}
              <span>
                <a href={current.affiliateLink} target="_blank">
                  LINK
                </a>
              </span>
            </h3>
        ...
        <div className={styles.moreInfoWrapper}>
          ...
          <Link href={`/books/${book.bookid}`}>
            ...
            <Image
              alt="Small Share Logo"
              src="/images/Share_Logo_Small.png"
              width={30}
              height={30}
